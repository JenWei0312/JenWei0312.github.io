...
My work is available primarily through the [GitHub](https://github.com/JenWei0312) and 🤗 [Hugging Face Hub](https://huggingface.co/bird-of-paradise). These projects range from first-principles implementations of modern AI systems to original research on optimization, memory, and training dynamics.
